...
//       date: new Date().toLocaleString(),
//       status: "Processing",
//       address: { ...form, country: "India", state: "Odisha" },
//       paymentMethod: payment
//     }
...
//                 <input name="firstName" placeholder="First name *" value={form.firstName} onChange={handleChange} className="border p-3 rounded md:col-span-1 col-span-2" />
//                 <input name="lastName" placeholder="Last name *" value={form.lastName} onChange={handleChange} className="border p-3 rounded md:col-span-1 col-span-2" />

//                 <input name="company" placeholder="Company name (optional)" value={form.company} onChange={handleChange} className="border p-3 rounded col-span-2" />

//                 <input value="India" readOnly className="border p-3 rounded col-span-2 bg-gray-100" />

//                 <input name="address1" placeholder="Street address *" value={form.address1} onChange={handleChange} className="border p-3 rounded col-span-2" />
//                 <input name="address2" placeholder="Apartment, suite, unit, etc. (optional)" value={form.address2} onChange={handleChange} className="border p-3 rounded col-span-2" />

//                 <input name="city" placeholder="Town / City *" value={form.city} onChange={handleChange} className="border p-3 rounded" />
//                 <input value="Odisha" readOnly className="border p-3 rounded bg-gray-100" />

//                 <input name="pincode" placeholder="PIN Code *" value={form.pincode} onChange={handleChange} className="border p-3 rounded" />
//                 <input name="phone" placeholder="Phone *" value={form.phone} onChange={handleChange} className="border p-3 rounded" />

//                 <input name="email" placeholder="Email address *" value={form.email} onChange={handleChange} className="border p-3 rounded col-span-2" />
    ...
    try {
      const res = await fetch("/api/orders", {
        ...
        headers: {
          ...
          Authorization: `Bearer ${token}`, // JWT for user identification
        },
        ...
        <div className="grid lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm">
              ...
              <div className="grid grid-cols-2 gap-4">
                <input
                  ...
                  onChange={handleChange}
                  className="border p-3 rounded md:col-span-1 col-span-2"
                />
                <input
                  name="lastName"
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm">
              ...
              <p className="text-sm text-gray-500 mb-4">Pay with cash upon delivery.</p>
              <label className="flex gap-2">
                <input
                  type="checkbox"
                  checked={agree}
